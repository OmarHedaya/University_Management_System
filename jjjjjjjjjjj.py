...
def interface():
    ...
    admin1 = Admin(1, "Admin User", "admin@univ.edu")
    admin2= Admin(123,"aly","email admin")
    ...
    admins={str(admin1.admin_id):admin1,str(admin2.admin_id):admin2}
    ...
    while True:
        ...
        if role == 'student' and user_id in students:
            student_menu(students[user_id],dept)
